...
**Version:** 19.0.1.0.1 -- **License:** LGPL-3 -- **Publisher:** FoxPink -- Maintained for **Odoo 19.0**
...
- This branch is validated for Odoo 19.0; other series require their dedicated validated build
...
| Odoo Version | Status |
|---|---|
| 19.0 | ✅ Validated release candidate |
| 18.0 | Planned validation |
